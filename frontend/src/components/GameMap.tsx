      ...
      {(() => {
        ...
        return (
          ...
          >
            ...
            {agent.chatBubble && !isDead && (
              <div 
                className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 animate-fadeInUp group/bubble cursor-pointer z-30 hover:z-50 max-w-[180px] hover:max-w-[450px] transition-all duration-200"
